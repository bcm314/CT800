...
/*this is needed for the hash tables,so avoid additional ROM lookup
  waitstates and link it into RAM.*/
DATA_SECTION static uint8_t Flag_Comp_To_Move[16] =
{
    0,  /*invalid*/
    1U, /*piece move*/
...
/*this is needed in the move generator for checking against the depth
  killers, so avoid additional ROM lookup waitstates and link it into RAM.*/
DATA_SECTION static uint8_t Flag_Move_To_Comp[19] =
{
